            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Sign In As Admin</b></h4>
                        <div class="p-3">
                            @if ($errors->any())
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="user_name" class="form-control" type="text" name="user_name" required="" placeholder="User Name">
                                    </div>
                                </div>

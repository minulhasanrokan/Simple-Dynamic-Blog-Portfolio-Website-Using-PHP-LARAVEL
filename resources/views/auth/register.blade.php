            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Register As Admin</b></h4>
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="user_name" class="form-control" type="text" name="user_name"  placeholder="Enter User Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="password_confirmation" class="form-control" type="password" name="password_confirmation"  placeholder="Enter Password Confirmation" required>
                                    </div>
                                </div>

                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" id="email" name="email" type="email" required="" placeholder="Enter Email" value="{{$request->email}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" id="password_confirmation" name="password_confirmation" type="password" required="" placeholder="Enter Password Confirmation">
                                    </div>
                                </div>

...
@section('content')
<title>{!!$system_settings->name!!} - Add Working Process Details</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Working Process Details</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Working Process Details</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form method="POST" autocomplete="off" action="{{route('admin.store.process')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Working Process Step</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="process_step" id="process_step" type="text" placeholder="Enter Working Process Step" value="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Working Process Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="title" id="title" type="text" placeholder="Enter Working Process Title" value="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" name="long_des" id="long_des" placeholder="Enter Working Process Description" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <input style="float: right;" type="submit" value="Add Working Process" class="btn btn-info">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->

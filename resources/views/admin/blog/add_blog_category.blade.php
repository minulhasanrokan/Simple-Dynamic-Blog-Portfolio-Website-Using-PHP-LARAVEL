...
@section('content')
<title>{!!$system_settings->name!!} - Add Blog Category Details</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.store.blog.category')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Category Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ old('title') }}" name="title" id="title" type="text" placeholder="Enter Category Title" required>
                                    @error('title')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                     <input class="form-control" name="short_title" id="short_title" type="text" placeholder="Enter Short Category Title" value="{{ old('short_title') }}" required>
                                     @error('short_title')
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            {{ $message }}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="short_des" id="short_des" placeholder="Enter Category Short Description" required>{{ old('short_des') }}</textarea>
                                    @error('short_des')
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            {{ $message }}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" name="long_des" id="long_des" placeholder="Enter Category Long Description" required>{{ old('long_des') }}</textarea>
                                    @error('long_des')
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            {{ $message }}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input onchange="readUrl(this);" accept="image/*" class="form-control" name="cat_img" id="cat_img" type="file" required placeholder="Upload Slider Photo">
                                    @error('cat_img')
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            {{ $message }}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>

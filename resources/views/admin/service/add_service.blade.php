...
@section('content')
<title>{!!$system_settings->name!!} - Add Service Details</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Service Details</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form method="POST" autocomplete="off" action="{{route('admin.store.service')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Service Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="title" id="title" type="text" placeholder="Enter Service Title" value="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="short_des" id="short_des" placeholder="Enter Service Short Description" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" name="long_des" id="long_des" placeholder="Enter Service Long Description" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input onchange="readUrl(this);" accept="image/*" class="form-control" name="service_img" id="service_img" type="file" placeholder="Upload Service Photo">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <input style="float: right;" type="submit" value="Add Service" class="btn btn-info">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->

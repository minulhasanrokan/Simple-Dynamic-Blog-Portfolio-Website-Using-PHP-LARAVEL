...
@section('content')
<title>{!!$system_settings->name!!} - Add Resume Details</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Resume Details</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Resume Details</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form method="POST" autocomplete="off" action="{{route('admin.store.resume')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <embed id="pdf" src="" scrolling="auto" />
                            ...
                            <input style="float: right;" type="submit" value="Upload Resume" class="btn btn-info">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
